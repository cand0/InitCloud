...
resource "aws_subnet" "cand3_cand3" {
  vpc_id = "${aws_vpc.cand3.id}"
  cidr_block = cidrsubnet(aws_vpc.cand3.cidr_block, 8, 3)
}
resource "aws_subnet" "cand3_cand4" {
  vpc_id = "${aws_vpc.cand3.id}"
  cidr_block = cidrsubnet(aws_vpc.cand3.cidr_block, 8, 4)
}
